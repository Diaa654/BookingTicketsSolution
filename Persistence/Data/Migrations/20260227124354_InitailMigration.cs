    ...
    public partial class InitailMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CityTrips", x => new { x.FromCityId, x.ToCityId, x.TripId });
                    table.ForeignKey(
                        name: "FK_CityTrips_Cities_FromCityId",
                        column: x => x.FromCityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CityTrips_Cities_ToCityId",
                        column: x => x.ToCityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trips_busId_DateOfDeparture",
                table: "Trips",
                columns: new[] { "busId", "DateOfDeparture" },
                unique: true);
